...
// Compatibility exports for callers that historically sourced task execution
// events from this module. The canonical schema lives in execution-event.ts so
// task and session streams retain the same fields during Zod parsing.
export {
