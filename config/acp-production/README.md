...
`ACP_CODEX_RUNTIME_IMG`, `ACP_CLAUDE_RUNTIME_IMG`, and
`ACP_COPILOT_RUNTIME_IMG`, or replace all three runtime entries in
`runtime-images.env` before applying. Never deploy a rendered all-zero
placeholder.
