...
func TestDockerfilePinsOpenCodeArtifactsAndRuntime(t *testing.T) {
	...
	for _, value := range []string{
		...
		acp.OpenCodeRipgrepLinuxX64TarSHA256,
		acp.OpenCodeRipgrepLinuxARM64TarSHA256,
		...
		"COPY --from=opencode-layout /opt/ripgrep/licenses/LICENSE-MIT /opt/ripgrep/licenses/UNLICENSE " +
